...
class TestKeysManager {
    ...
    synchronized static byte[] getNextRootEntropy() {
        if (currentAccountIndex >= testKeys.length) {
            currentAccountIndex = 0;
        }
        return testKeys[currentAccountIndex++];
    }
    ...
    private final static byte[][] testKeys = {
            {
                    (byte) 0x43,
                    (byte) 0x2f,
                    (byte) 0x58,
