...
public class TestFogConfig {
    ...
    private static final byte[] buildtestFogAuthoritySpki = Base64.decode("", Base64.DEFAULT);
        ...
        switch (testEnvironment) {
            case BUILD_TEST:
                return new TestFogConfig(fogUri, consensusUri, TEST_DEV_USERNAME,
                        TEST_DEV_PASSWORD, getMainNetClientConfig(),
                        buildtestFogAuthoritySpki, "");
            case MOBILE_DEV:
                return new TestFogConfig(fogUri, consensusUri, TEST_DEV_USERNAME,
    ...
    @NonNull
    private static ClientConfig getAllowAllDebugClientConfig() {
        try {
            ClientConfig clientConfig = new ClientConfig();
            clientConfig.fogView = new ClientConfig.Service()
                    .withVerifier((new Verifier()))
    ...
    @NonNull
    private static ClientConfig getMainNetClientConfig() {
        try {
            ClientConfig clientConfig = new ClientConfig();
            clientConfig.fogView = new ClientConfig.Service()
                    .withVerifier((new Verifier())
