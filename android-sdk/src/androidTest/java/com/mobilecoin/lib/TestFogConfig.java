...
public class TestFogConfig {
	...
	// This is the root certificate of the SSL provider the *.test.mobilecoin.com infrastructure uses.
	// The way this was obtained in the most recent update was:
	// 1. Figure out what is the root of trust using `openssl s_client -connect fog.test.mobilecoin.com:443` and looking at the output
	// 2. It was found out to be Internet Security Research Group ISRG Root X1
	// 3. This is letsencrypt and they publish their certificates on https://letsencrypt.org/certificates/
	// 4. The ISRG Root X1 PEM file was grabbed, the ------ header/footer and all new lines were stripped and this string is the result
