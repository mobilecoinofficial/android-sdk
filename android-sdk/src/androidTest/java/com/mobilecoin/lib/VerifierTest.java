...
public class VerifierTest {
    ...
    @Rule public ExpectedException exceptionChecker = ExpectedException.none();
    ...
    public void withMrSigner_validMrSigner_doesNotThrowException() throws Exception {
        ...
        String VALID_MR_SIGNER_HEX =
                "7ee5e29d74623fdbc6fbf1454be6f3bb0b86c12366b7b478ad13353e44de8411";
        verifier.withMrSigner(Hex.toByteArray(VALID_MR_SIGNER_HEX), PRODUCT_ID, SECURITY_VERSION,
                CONFIG_ADVISORIES, HARDENING_ADVISORIES);
    }
    ...
    @Test
    public void withMrEnclave_mrSignerHasLessThan32Digits_throwsAttestationException() throws Exception {
        // Corresponds to 9 unsigned 8 bit integers.
    ...
    @Test
    public void withMrEnclave_mrSignerHasMoreThan32Digits_throwsAttestationException() throws Exception {
        // Corresponds to 33 unsigned 8 bit integers.
        String moreThan32DigitsMrSignerHex =
                "7ee5e29d74623fdbc6fbf1454be6f3bb0b86c12366b7b478ad13353e44de8411ff";

        exceptionChecker.expect(AttestationException.class);
        verifier.withMrEnclave(Hex.toByteArray(moreThan32DigitsMrSignerHex),
                CONFIG_ADVISORIES, HARDENING_ADVISORIES);
    }
    ...
    public void withMrEnclave_validMrEnclave_doesNotThrowException() throws Exception {
        // Corresponds to 32 unsigned 8 bit integers.
        String VALID_MR_ENCLAVE_HEX =
                "7ee5e29d74623fdbc6fbf1454be6f3bb0b86c12366b7b478ad13353e44de8411";

        exceptionChecker.expect(AttestationException.class);
        verifier.withMrEnclave(Hex.toByteArray(VALID_MR_ENCLAVE_HEX),
                CONFIG_ADVISORIES, HARDENING_ADVISORIES);
    }
}
