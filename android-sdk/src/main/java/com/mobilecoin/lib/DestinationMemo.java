...
public final class DestinationMemo extends Native implements TxOutMemo {
   ...
   **/
  static DestinationMemo create(@NonNull byte[] memoData) {
    ...
    return new DestinationMemo(memoData);
  }

  private DestinationMemo(byte[] memoData) {
    try {
  ...
  public DestinationMemoData getDestinationMemoData(
